...
class Matrix(object):
    ...
    def inverse(self):
        ...
        if(self.h == 1 and self.w == 1):
            ...
            idet = 1/det
            inv[0][0] = self.g[1][1] * idet
            inv[0][1] = -self.g[0][1] * idet
            inv[1][0] = -self.g[1][0] * idet
            inv[1][1] = self.g[0][0] * idet
    ...
    def __add__(self,other):
        ...
        # TODO - your code here
        #
        addMatrix = zeroes(self.h,self.w)
        for i in range(self.h):
            for j in range(self.w):
                 addMatrix[i][j] = self.g[i][j] + other.g[i][j]
        return addMatrix
    ...
    def __sub__(self, other):
        ...
        # TODO - your code here
        #
        subMatrix = zeroes(self.h, self.w)
        for i in range(self.h):
            for j in range(self.w):
                 subMatrix[i][j] = self.g[i][j] - other.g[i][j]     
        return subMatrix
